...
export const Button = (props: ButtonProps) => {
  ...
  const buttonVariantClassName = cva(
    "outline-none focus:outline-none flex items-center justify-center rounded-[2.5rem] text-center gap-4",
    {
      variants: {
        variant: {
        ...
        size: {
          ...
          lg: "px-4 py-[.875rem] text-[1.25rem] leading-none font-kelly-slab tracking-none",
        },
      },
      defaultVariants: {
        variant: "primary",
